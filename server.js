...
// MySQL Database Connection Pool (Configured for Aiven Cloud)
...
// Visit /api/init-db in your browser to create the table
app.get("/api/init-db", async (req, res) => {
    try {
        ...
        `);
        res.status(200).json({message: "Table 'jobs' created successfully!"});
    } catch (error) {
